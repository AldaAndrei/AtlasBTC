...
public class ColorSensor {
    ...
    private DistanceUnit distanceUnit = DistanceUnit.INCH; // Defaulting to INCH, can be changed
     ...
     * Constructs a color sensor, defaults to ARGB
     */
    public ColorSensor(RevColorSensorV3 colorSensorV3, DistanceUnit distanceUnit) {
        this(colorSensorV3);
     ...
     */
    public ColorSensor(@NonNull HardwareMap hardwareMap, String name) {
     ...
     * Constructs a color sensor using the given hardware map and name, defaults to ARGB
     */
    public ColorSensor(@NonNull HardwareMap hardwareMap, String name, DistanceUnit distanceUnit) {
        this((RevColorSensorV3) hardwareMap.colorSensor.get(name));
        this.distanceUnit = distanceUnit;
    }
    ...
    /**
     * Gets the distance value from the sensor using the default unit
     */
    ...
    /**
     * Closes the sensor to free up resources
     */
    public void disable() {
        colorSensorV3.close();
    }
